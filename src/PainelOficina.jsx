        ...
        <div style={{ overflowY:"auto", padding:"20px 24px", display:"flex", flexDirection:"column", gap:20 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16 }}>
            <div style={{ background:"var(--cinza,#111)", borderRadius:10, padding:16, border:"1px solid var(--borda,#2a2a2a)" }}>
              <p style={{ color:"#e53e3e", fontSize:11, fontWeight:700, textTransform:"uppercase", margin:"0 0 10px" }}>👤 Cliente</p>
              <p style={{ color:"var(--texto,#fff)", fontWeight:700, fontSize:15, margin:"0 0 4px" }}>{os.cliente || "—"}</p>
              {os.telefone && <p style={{ color:"var(--texto-sub,#888)", fontSize:13, margin:"0 0 2px" }}>📱 {os.telefone}</p>}
            </div>
            <div style={{ background:"var(--cinza,#111)", borderRadius:10, padding:16, border:"1px solid var(--borda,#2a2a2a)" }}>
              <p style={{ color:"#e53e3e", fontSize:11, fontWeight:700, textTransform:"uppercase", margin:"0 0 10px" }}>🚗 Veículo</p>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16 }}>
            <div style={{ background:"var(--cinza,#111)", borderRadius:10, padding:16, border:"1px solid var(--borda,#2a2a2a)" }}>
              <p style={{ color:"#e53e3e", fontSize:11, fontWeight:700, textTransform:"uppercase", margin:"0 0 10px" }}>🔧 Serviço</p>
            ...
            <div style={{ background:"var(--cinza,#111)", borderRadius:10, padding:16, border:"1px solid var(--borda,#2a2a2a)" }}>
              <p style={{ color:"#e53e3e", fontSize:11, fontWeight:700, textTransform:"uppercase", margin:"0 0 10px" }}>💰 Financeiro</p>
          ...
          {(os.obs || os.pecas) && (
            <div style={{ background:"var(--cinza,#111)", borderRadius:10, padding:16, border:"1px solid var(--borda,#2a2a2a)" }}>
              <p style={{ color:"#e53e3e", fontSize:11, fontWeight:700, textTransform:"uppercase", margin:"0 0 10px" }}>📝 Descrição / Peças</p>
          ...
          {checkItens.length > 0 && (
            <div style={{ background:"var(--cinza,#111)", borderRadius:10, padding:16, border:"1px solid var(--borda,#2a2a2a)" }}>
              <p style={{ color:"#e53e3e", fontSize:11, fontWeight:700, textTransform:"uppercase", margin:"0 0 10px" }}>✅ Checklist</p>
